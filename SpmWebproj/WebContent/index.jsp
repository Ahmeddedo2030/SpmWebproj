...
<head>
    ...
    <meta name="keywords" content="Data Mining,Weka">
    <meta name="author" content="PandasHSEmden">
        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#hero">
                    ...
                    <span class="brandicon icon-bar-chart"></span>
                    <span class="brandname">BauDas</span>
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="mailto:kingpenny@foxmail.com"><span class="btnicon icon-envelope-open"></span>Contact</a></li>
                    <li><a href="login.jsp"><span class="btnicon icon-login"></span>Login Now</a></li>
                </ul>
...
<div id="services" class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-duration="3s">
            <a  href="login.jsp"> <img src="img/s2.png" alt=""></a>
            <h4> Data Analyse </h4>
            <p>Start your Experience Journey</p>
        </div>
        <!-- ITEM END -->
        ...
        <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-duration="3s">
            <a  href="login.jsp"> <img src="img/s3.png" alt=""></a>
            <h4> Data Analyse </h4>
            <p>Start your Experience Journey</p>
        </div>
        <!-- ITEM END -->
        ...
        <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-duration="3s">
            <a  href="login.jsp"> <img src="img/s4.png" alt=""></a>
            <h4> Data Analyse </h4>
            <p>Start your Experience Journey</p>
        </div>
        <!-- ITEM END -->
        ...
        <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-duration="3s">
            <a  href="login.jsp"> <img src="img/s5.png" alt=""></a>
            <h4> Data Analyse </h4>
            <p>Start your Experience Journey</p>
        </div>
        <!-- ITEM END -->
        ...
        <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-duration="3s">
            <a  href="login.jsp"> <img src="img/s6.png" alt=""></a>
            <h4> Data Analyse </h4>
            <p>Start your Experience Journey</p>
        </div>
        <!-- ITEM END -->
...
<div id="portfolio">
    ...
    <a class="btn btn-default wow fadeInUp" href="login.jsp" role="button">
...
<div id="about" class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-6 wow bounceIn" data-wow-duration="2s">
            ...
            <div class="quote">
                <blockquote>
                    <p>The Lord works in mysterious ways,but possums do not.</p>
                </blockquote>
                <h5>Finn Wundram</h5>
                <p>Projektleiter,Niedersachsen</p>
            </div>
        </div>
        ...
        <div class="col-md-6 wow bounceIn" data-wow-duration="3s">
            ...
            <div class="quote">
                <blockquote>
                    <p>Genius only means hard-working all one's life.</p>
                </blockquote>
                <h5>Yixin Peng</h5>
                <p>Web Entwickeler,China</p>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="footerlinks">
            ...
            <ul>
                ...
                <li><a href="mailto:kingpenny@foxmail.com">Contact</a></li>
            </ul>
        </div>
        <!-- FOOTER LINKS END -->
        ...
        <div class="copyright">
            ...
            <p><a href="#">BauDas</a> , worth to trust</p>
        </div>
